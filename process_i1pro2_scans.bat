...
scanner_refl_fix -ML i1pro2/chart-522.tif "i1pro2/Pro1000 CG Chart 522 Patches_M2.txt" i1pro2/scanner-522.txt
...
rem Read patches from uncorrected scan chart and combine with i1Pro2/i1Profiler measurements
scanner_refl_fix -ML i1pro2/chart-522_f.tif "i1pro2/Pro1000 CG Chart 522 Patches_M2.txt" i1pro2/scanner-522_f.txt
